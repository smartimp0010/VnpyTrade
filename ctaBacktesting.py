...
class BacktestingEngine(object):
    ...
    def loadHistoryDataCsv(self):
        ...
        df = pd.read_csv(
            '/Users/bettelin/Desktop/VnpyTrade-develop/examples/CtaBacktesting/TXF01_Tick.csv', index_col=False)
    ...
    def crossLimitOrder(self):
        ...
        for orderID, order in self.workingLimitOrderDict.items():
            ...
            if buyCross or sellCross:
                ...
                trade.tradeTime = self.dt.strftime('%D %H:%M:%S.%f')
                trade.dt = self.dt
    ...
    def sendOrder(self, vtSymbol, orderType, price, volume, strategy):
        ...
        order.orderID = orderID
        order.vtOrderID = orderID
        order.orderTime = self.dt.strftime('%D %H:%M:%S.%f')
    ...
    def cancelOrder(self, vtOrderID):
        ...
        if vtOrderID in self.workingLimitOrderDict:
            ...
            order.cancelTime = self.dt.strftime('%D %H:%M:%S.%f')
